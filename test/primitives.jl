...
@testset "dims" begin
    ...
    @test typeof(dims(da)) ==
        Tuple{X{Sampled{Int,StepRange{Int,Int},ForwardOrdered,Regular{Int},Points,NoMetadata},NamedTuple{(),Tuple{}}},
              Y{Sampled{Int,UnitRange{Int},ForwardOrdered,Regular{Int},Points,NoMetadata},NamedTuple{(),Tuple{}}} }
end
